...
function searchGoogle() {
    ...
    if (searchText) {
      const finalText = " this is what i found on internet " + searchText;
      speak(finalText);
      window.open(`https://www.google.com/search?q=${encodeURIComponent(searchText)}`, "_blank");
      textInput.value = ""; // Clear the input after searching
    }
  }
  enterButton.addEventListener("click", searchGoogle);
...
function takeCommand(message){
   voice.style.display="none"
    ...
    if(message.includes("hello")||message.includes("hey")){
        ...
        speak("i am virtual assistant ,created by Umang Pant ")
      ...
      speak("time is" + time)
        ...
        let finalText="this is what i found on internet regarding" + message.replace("Lyra","") 
        speak(finalText)
